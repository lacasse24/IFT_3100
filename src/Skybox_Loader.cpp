...
{
	GLuint hprojection, hvue, lumamb;
	...
	hvue = glGetUniformLocation(skyboxProgram, "gview");
	assert(hvue != 0xFFFFFFFF);
	//lumamb = glGetUniformLocation(skyboxProgram, "LumAmbiante");
	//assert(hvue != 0xFFFFFFFF);
	...
	GLint color_location = glGetUniformLocation(skyboxProgram, "color");
	float color[3] = { 0.f, 255.f, 0.f };
